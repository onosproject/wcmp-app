...
func (r *Reconciler) createRelation(ctx context.Context, conn p4rt.Conn) (controller.Result, error) {
...
func (r *Reconciler) deleteRelation(ctx context.Context, connID p4rt.ConnID) (controller.Result, error) {
